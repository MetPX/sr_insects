...
sr_cpost -config pelle_dd1_f04.conf ${TESTSTATICDATA} >$LOGDIR/sr_cpost_pelle_dd1_f04_01.log 2>&1 &
sr_cpost -config pelle_dd2_f05.conf ${TESTSTATICDATA} >$LOGDIR/sr_cpost_pelle_dd2_f05_01.log 2>&1 &
